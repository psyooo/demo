...
parser.add_argument("--band", type=int, default=180,help='设置第三阶段中U-net隐藏层特征通道数目，论文设置为240')
...
parser.add_argument('--niter2_UNet', type=int, default=2500, help='#of iter at starting learning rate 2000')
parser.add_argument('--niter_decay2_UNet', type=int, default=2500, help='#of iter to linearly decay learning rate to zero')

parser.add_argument("--lr_stage3_dip", type=float, default=4e-3,help='学习率4e-3')
parser.add_argument('--niter3_dip', type=int, default=5000, help='# of iter at starting learning rate 7000')
parser.add_argument('--niter_decay3_dip', type=int, default=5000, help='# of iter to linearly decay learning rate to zero')
