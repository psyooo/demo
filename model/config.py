...
parser.add_argument('--data_name',type=str, default="TG",help='houston18=8 DC=10 TG=12 Chikusei_128=16 PaviaU_256x256、houston、Indian_pines')
parser.add_argument("--gpu_ids", type=str, default='0', help='指定运行的GPU ID')
parser.add_argument('--checkpoints_dir',type=str, default='TG',help='结果存储地址')
...
parser.add_argument("--Rank", type=int, default=13,help='CP分解的秩')
...
args.expr_dir=os.path.join('TG', args.data_name+'SF'+str(args.scale_factor)+'_CPRank'+str(args.Rank)+'_noise-'+str(args.noise)+
